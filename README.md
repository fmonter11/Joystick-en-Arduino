...
Después se realizó una práctica física que consistió en mover la palanca del joystick en diversas direcciones para obtener los valores de los ejes de traslación deseados.
|         |   Eje: Y  Valor: 0   |   |
| :-------------: |:-------------:| :-------------:|
